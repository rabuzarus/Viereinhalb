...
<div class="wall-item-container {{$item.indent}} {{$item.shiny}} " id="item-{{$item.id}}">
	...
	<div class="wall-item-bottom">
		...
		<div class="wall-item-actions">
			...
			{{/if}}
			{{if $item.ignore}}
				<a href="#" id="ignore-{{$item.id}}" onclick="doignore({{$item.id}}); return false;"  class="{{$item.ignore.classdo}}"  title="{{$item.ignore.do}}"><i class="icon-check-minus icon-large"></i></a>
				<a href="#" id="unignore-{{$item.id}}" onclick="doignore({{$item.id}}); return false;"  class="{{$item.ignore.classundo}}"  title="{{$item.ignore.undo}}"><i class="icon-check-empty icon-large"></i></a>
			{{/if}}
			{{if $item.tagger}}
